...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='ijcai_15',
                        help='Choose a dataset from {Beibei,Taobao,retail_rocket, ijcai_15, tmall}')
    ...
    parser.add_argument('--wid', nargs='?', default='[0.01,0.01,0.01,0.01,0.01]',
